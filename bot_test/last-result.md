...
[send] /log
[file] log.txt 0.0MB
[logfile log.txt 538 lines, filtered 66]
  ...
  Traceback (most recent call last):
    ...
    File "/kaggle/working/WZML-X/bot/helper/mirror_leech_utils/upload_utils/telegram_uploader.py", line 605, in _upload_file
      sent_msg = await self._hu.upload(
    File "/kaggle/working/WZML-X/bot/helper/ext_utils/hyperul_utils.py", line 178, in upload
  [23-Sep-26 10:00:06 PM] [INFO] - WZFIX music: resolving https://open.spotify.com/track/52HEmNCNvewyByx7xofF0T (from text)
  [23-Sep-26 10:07:16 PM] [ERROR] - Upload part failed after 5 attempts
  Traceback (most recent call last):
  [23-Sep-26 10:07:16 PM] [ERROR] - HypertgUL fail Amrinder Gill - Mera Deewanapan.mp3: TimeoutError: Request timed out
  [23-Sep-26 10:07:16 PM] [ERROR] - Request timed out. Path: /usr/src/app/downloads/1990/Amrinder Gill - Mera Deewanapan.mp3
  Traceback (most recent call last):
    File "/kaggle/working/WZML-X/bot/helper/mirror_leech_utils/upload_utils/telegram_uploader.py", line 605, in _upload_file
      sent_msg = await self._hu.upload(
    File "/kaggle/working/WZML-X/bot/helper/ext_utils/hyperul_utils.py", line 178, in upload
  ...
  Traceback (most recent call last):
    ...
    File "/kaggle/working/WZML-X/bot/helper/mirror_leech_utils/upload_utils/telegram_uploader.py", line 605, in _upload_file
      sent_msg = await self._hu.upload(
    File "/kaggle/working/WZML-X/bot/helper/ext_utils/hyperul_utils.py", line 178, in upload
  [23-Sep-26 10:09:27 PM] [INFO] - WZFIX music: resolving https://open.spotify.com/album/2i3BK7cJeD6jErpZVaH9Ai (from text)
  [23-Sep-26 10:36:15 PM] [ERROR] - Upload part failed after 5 attempts
  Traceback (most recent call last):
  [23-Sep-26 10:36:15 PM] [ERROR] - HypertgUL fail Amrinder Gill - Mera Deewanapan.mp3: TimeoutError: Request timed out
  [23-Sep-26 10:36:15 PM] [ERROR] - Request timed out. Path: /usr/src/app/downloads/1995/Amrinder Gill - Mera Deewanapan.mp3
  Traceback (most recent call last):
    File "/kaggle/working/WZML-X/bot/helper/mirror_leech_utils/upload_utils/telegram_uploader.py", line 605, in _upload_file
      sent_msg = await self._hu.upload(
    File "/kaggle/working/WZML-X/bot/helper/ext_utils/hyperul_utils.py", line 178, in upload
